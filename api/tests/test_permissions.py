...
Cobertos:
  ...
  - requer_qualquer_modulo: NOVO — usado pelo drilldown de contador-leads
"""
import pytest
...
class TestModulosDoCargoRegressao:
    """
    Garantia explícita de que Hunter/Farmer continuam SEM módulo 'clientes'
    (importante: o drilldown não deve nem aparecer na navegação principal
    de Clientes — só funciona pelo drawer da Carteira).
    """
